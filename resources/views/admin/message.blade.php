...
@section('mainmodule','')
@section('modulename','Custom Message')
@section('pagename','custom message')
    ...
    <div class="col-md-12">
      ...
      // local user message
       if (Session()->get('is_admin') == 0) { ?>
        <form role="form" class="form-horizontal" method="post" action="{{route('custom.message.store')}}" enctype="multipart/form-data">
          @if ($errors->any())
