...
@section('title','Edit Slide Image')
@section('mainmodule','')
        ...
        <div class="col-md-8 offset-md-2">
            <div class="card card-info">
                <div class="card-header">
                    <h3 class="card-title">Edit Slide Image</h3>
                ...
                <form class="form-horizontal" method="post" action="{{route('slide.image.update')}}" enctype="multipart/form-data"> 
                    {{ csrf_field() }}
                    <div class="card-body">
                        ...
                        <div class="form-group required row">
                            ...
                            <div class="col-sm-10">
                                <input type="file" required name="slide_image" class="form-control">
                            </div>
                        </div>
